...
class Window(Frame):
    ...
    def init_window(self):
        ...
        #Calibration Buttons
        Button_CalI = Button(self, text="Cal Set", width = width, height = 2,command=CalISet)
        Button_CalI.place(x=x[6], y=y[4])
...
#        Button_CalIII.place(x=x[7], y=y[2])   
        ...
        Button_Quit.place(x=x[7], y=y[0])        
        
        #System Reset
        Button_Reset = Button(self, text="System Reset", width = width, height = 2,command=Reset)
        Button_Reset.place(x=x[7], y=y[1])  

        #Play Victory Song!
        Button_VictorySong = Button(self, text="Winning", width = width, height = 2,command=Victory)
        Button_VictorySong.place(x=x[7], y=y[2])    
        
        #Play Taunt
        Button_VictorySong = Button(self, text="Taunt", width = width, height = 2,command=Taunt)
        Button_VictorySong.place(x=x[7], y=y[3])    
        
        #Play Imperial March
        Button_VictorySong = Button(self, text="Death Star", width = width, height = 2,command=StarWars)
        Button_VictorySong.place(x=x[7], y=y[4])    
        
        Title = Label(root, text="ME 405 Term Project", font=("Helvetica", 32))
        Title.place(x=250, y=0)
        
        Title = Label(root, text="By Thomas Goehring, Jason Grillo, Trent Peterson", font=("Helvetica", 12))
        Title.place(x=250, y=125)
 
#        #Photo = PhotoImage(file = "C:\\Users\\Thomas Goehring\\Desktop\\mecha10\\Project_UI\\IMG_5215.GIF")
#        image = Image.open("C:\\Users\\Thomas Goehring\\Desktop\\mecha10\\Project_UI\\IMG_5214.jpg")
...
def Victory():
    print('Winning')
    file = '"C:\\Users\\Thomas Goehring\\Desktop\\mecha10\\Project_UI\\17 - We Are the Champions.mp3"'
    os.system(file)
...
def StarWars():
    print('Winning')
    file = '"C:\\Users\\Thomas Goehring\\Desktop\\mecha10\\Project_UI\\Star Wars- The Imperial March (Darth Vaders Theme).mp3"'
    os.system(file)
