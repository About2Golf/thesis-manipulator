...
class Motor_Task:
    ...
    def __init__(self, position, coordinate, timer, EN_Pin, pin1, pin2, Kp, Ki, saturation):
...
#                self.coordinate.put(2000)
                if self.coordinate.any():
                    ...
                    # inserted this to test if it will stop the tilt spin upon startup... try this and if not comment out
                    self.Motor.set_duty_cycle(0)
