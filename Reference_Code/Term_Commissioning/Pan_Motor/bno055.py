...
#    @endcode 
    ...
    def __init__ (self, i2c, address):
        ...
        self._i2c.mem_write(NDOF_MODE, self._address, _MODE_REGISTER)
    ...
    def get_euler_pitch(self):
        ...
        self._pitch_value = int(self._pitch_decode[0]/16)
    ...
    def get_euler_roll(self):
        ...
        self._roll_value = int(self._roll_decode[0]/16)
    ...
    def get_euler_yaw(self):
        ...
        self._yaw_value = int(self._yaw_decode[0]/16)
