...
with serial.Serial('COM5',115200, timeout = .1) as ser_port:
    ...
    plot_data(data_list,plot_title = 'Step Response, 15 Degrees, Kp=3, Ki=.2',xtitle = 'Time [ms]', ytitle = 'Position [ticks]')    